...
- **Lab 7: EdgeImpulse** ([slides](/contents/labs/Lab07-EdgeImpulse/))  
  - *Edge AI: Principles and Applications* ([pdf](https://arxiv.org/abs/2006.01203))  

- **Lab 8: Implementation of Neural Networks (ANN and CNN)** ([slides](/contents/labs/Lab08-ANN/))  
  - *Introduction to Convolutional Neural Networks* ([pdf](https://arxiv.org/abs/1511.08458))  

---

#### Week 8 (Feb 25 & 27)
- **Lecture 7: Convolutional Neural Networks and Computer Vision** ([slides](/contents/lectures/Lec08-CNN.pdf))  
  - *Computer Vision: Algorithms and Applications* ([book](https://szeliski.org/Book/))  

- **Lecture 8: Model Optimization and Efficiency Metrics** ([slides](/contents/lectures/Lec08-EfficiencyMetrcis.pdf))  
  - *Model Compression Techniques in Deep Learning* ([pdf](https://arxiv.org/abs/2003.13671))  

---

#### Week 9 (Mar 4 & 6)
- **Lecture 9: Introduction to Quantization** ([slides](/contents/lectures/Lec09-Quantization1.pdf))  
  - *Quantization and Pruning for Efficient Neural Network Inference* ([pdf](https://arxiv.org/abs/1710.01878))  

- **Lab 9: Model Parameters and Efficiency Metrics of ANN and CNN Models** ([slides](/contents/labs/Lab09-EfficiencyMetrics/))   - *Neural Network Compression: Techniques and Tools* ([pdf](https://arxiv.org/abs/2106.12956))  

---

#### Week 10 (Mar 11 & 13)
- **Lecture 10: Advanced Quantization** ([slides](/contents/lectures/Lec10-Quantization2.pdf))  
  - *Post-Training Quantization for Deep Learning Models* ([pdf](https://arxiv.org/abs/2006.12031))  

- **Lab 10: Quantization** ([slides](/contents/labs/Lab10-Quantization/))  
  - *A Guide to Model Quantization for AI Deployment* ([pdf](https://arxiv.org/abs/1908.01752))  



#### Week 11 (Mar 11 & 13)
- **Lecture 1: Introduction** ([slides](/contents/lectures/Lec01-introduction.pdf))  
  - Reading: *Edge Intelligence: Paving the Last Mile of Artificial Intelligence With Edge Computing* ([pdf](https://ieeexplore.ieee.org/document/8736011))
